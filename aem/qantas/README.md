# AEM Mobile Hybrid: ${appsFolderName}

This is the ${appsFolderName} project.

This is a basic AEM Mobile Qantas application authored using [Ionic Framework](http://ionicframework.com/).
...
1. Configure your [dashboard](http://localhost:4502/libs/mobileapps/admin/content/dashboard.html/content/mobileapps/qantas/shell) with analytics, push and phonegap build support
...
The [dashboard](http://localhost:4502/libs/mobileapps/admin/content/dashboard.html/content/mobileapps/qantas/shell) for the app that was previously added will
...
[http://localhost:4502/editor.html/content/mobileapps/qantas/en/about.html](http://localhost:4502/editor.html/content/mobileapps/qantas/en/about.html)
